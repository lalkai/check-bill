  ...
  <div class="a-card">
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-0">
      <div class="flex-1 min-w-0">
        ...
        <div class="flex items-center mt-1">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            stroke="currentColor" class="w-4 h-4 text-neutral-400 mr-1">
      ...
      <span class="text-xl font-semibold text-neutral-700 flex-shrink-0 whitespace-nowrap">{{
        formatCurrency(bill.amount) }} บาท</span>
    </div>

    <div class="flex flex-wrap items-center mt-4 gap-3">
      <button @click="removeBill" class="a-button-danger inline-flex items-center">
      ...
      <button @click="editBill" class="a-button-secondary inline-flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          class="w-4 h-4 mr-1">
          <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="mt-4 pt-4 border-t border-neutral-200">
      ...
      <div class="flex flex-wrap gap-2">
        <div v-for="payer in bill.payers" :key="payer.name"
