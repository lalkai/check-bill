...
<template>
  <div class="flex justify-center min-h-screen bg-gray-20">
    <div class="w-full px-4 py-6 max-w-screen-sm bg-base-300 shadow-md rounded-lg">
      <div>
        <h2 class="text-xl font-bold mb-4 text-right">ยอดรวมทั้งหมด: {{ billStore.totalAmount }} บาท</h2>
      </div>
