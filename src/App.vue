...
<template>
  <div class="min-h-screen bg-neutral-100 flex flex-col">
    <header class="bg-white/90 backdrop-blur-sm border-b border-neutral-200 sticky top-0 z-10">
      <div class="max-w-screen-md mx-auto px-4 py-5">
        <div class="flex flex-col items-center space-y-4">
          <!-- <h1 class="text-2xl font-semibold tracking-tight text-neutral-700">CheckBill</h1> -->
          <div class="flex items-center">
            <div class="a-card bg-gradient-to-b from-neutral-50 to-neutral-100 py-3 px-5 flex items-center">
    ...
    <!-- Footer -->
    <!-- <footer class="bg-white/90 backdrop-blur-sm border-t border-neutral-200 py-4">
      <div class="max-w-screen-md mx-auto px-4 text-center">
        <p class="text-sm text-neutral-400">CheckBill • สะดวก รวดเร็ว แม่นยำ</p>
      </div>
    </footer> -->
  </div>
</template>
